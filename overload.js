    ...
    if (connection === "connecting") {
      ...
      try {
        if (!fs.existsSync(`${sessionDir}/creds.json`)) {
          const code = await Ataa.requestPairingCode(BotNumber, "CROW INVISIBLE");
...
╔══════════════════════════════════════╗
║       ${chalk.bgBlackBright.bold(' CROW INVISIBLE SYSTEM ACTIVE ')}         ║
╠══════════════════════════════════════╣
...
bot.start((ctx) => {
  ...
  const message = `
👾 *Welcome to CROW INVISIBLE Settings!*
...
`;
  ...
  ctx.replyWithMarkdown(message, {
    ...
    reply_markup: {
      inline_keyboard: [
        [
          { text: "Contact Admin", url: "https://t.me/AzzCrow" }
        ]
      ]
    }
  });
...
<head>
  ...
  <title>CROW INVISIBLE</title>
  <link rel="icon" href="https://f.top4top.io/p_3542z9ydh1.jpg" type="image/jpg">
...
<body>
  ...
  <div class="container">
    <div class="icon" style="text-align: center; margin-bottom: 15px;">
      <img src="https://f.top4top.io/p_3542z9ydh1.jpg" class="logo" alt="CROW INVISIBLELogo">
    </div>
    ...
    <div class="buttons-grid">
      <button class="mode-btn" data-mode="androdelay2"><i class="fa fa-spinner"></i> CROW INVISIBLE KILL YOU</button>
      <button class="mode-btn" data-mode="androdelay"><i class="fa fa-spinner"></i> CROW INVISIBLE ATTACK</button>
      <button class="mode-btn full" data-mode="iosfc"><i class="fa fa-bolt"></i> CROW INVISIBLE IOS</button>
    </div>
...
app.get("/", (req, res) => {
  ...
  const filePath = path.join(__dirname, "CROW INVISIBLE", "Login.html");
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>CROW INVISIBLE</title>
  <link rel="icon" href="https://a.top4top.io/p_3550q9ko21.jpg" type="image/jpg">
  <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/4.0.0/css/bootstrap.min.css" rel="stylesheet">
  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/4.0.0/js/bootstrap.min.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600&display=swap" rel="stylesheet">
...
<body>
  ...
  <div class="container">
    <div class="icon" style="text-align: center; margin-bottom: 15px;">
      <img src="https://a.top4top.io/p_3550q9ko21.jpg" class="logo" alt="CROW INVISIBLEL">
    </div>
    <div class="username">Welcome, ${username || 'Anonymous'}</div>
    <div class="connected">CONNECTED</div>
